 ...
 * @LastEditors: yanwei
 * @LastEditTime: 2020-09-14 11:38:12
 * @Description : 宣传片页面代码
 */
...
Page({
  data: {
    URL_VIDEO_JSON: EXTERNAL_DATA_PATH + "data/videoXuanChuanPian.json",//宣传片json信息地址
   ...
   */
  touchEnd(e: any) {
    jumpNav2("videoxuanchuan", this.data.eventTouchStart, e);
  },
  /**
* 显示加载动画
*/
