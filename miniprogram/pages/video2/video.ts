...
Page({
   ...
   */
  onLoad() {
    let urlVideoKePuPian: string = 'https://a-1256136493.cos.ap-nanjing.myqcloud.com/fyhbss/data/videoKePuPian.json';//科普片json信息地址
    let video = util.getVideo(urlVideoKePuPian);
