...
let urlVideoXuanchuanPian: string = 'https://a-1256136493.cos.ap-nanjing.myqcloud.com/fyhbss/data/videoKePuPian.json';//宣传片json信息地址

function getVideoXuanChuanPian(): IVideo {              //接口实现，仅实现了基础方法代码，未实现回调方法，
  let func = <IVideo>function () {
    wx.request({                                          //网络请求取数据
      url: urlVideoXuanchuanPian,                         //简单地图标记点json文件的网络地址
      success(res) {
